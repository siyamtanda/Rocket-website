      ...
      <ThemeProvider theme={theme}>
        ...
        <div className={classes.wrapper}>
          ...
          <Typography variant="h5" className={classes.littleSpace} color="primary">
            Before applying for this software developer role in Sovtech company, I spent time reading the job 
            description and the person specification. I wanted to make sure I was both properly qualified for the role, 
            and I also had the appropriate experience and skills to help drive the company forward.
            </Typography>
            <Typography variant="h5" className={classes.littleSpace} color="primary">
